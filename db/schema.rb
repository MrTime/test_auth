...
ActiveRecord::Schema.define(version: 20160720091508) do
  ...
  add_index "cars", ["deleted_at"], name: "index_cars_on_deleted_at"
  add_index "cars", ["title"], name: "index_cars_on_title"
